  ...
  (
    ...
    const toggleCalendar = () => {
      if (inputRef.current) {
        ...
        setOpenUpward(spaceBelow < 300); // 🔥 main fix
      }
      setOpen(!open);
    };
    ...
    return (
      <div className={cn("relative w-full", className)} ref={containerRef}>
        ...
        {open && (
          <div
    className={cn(
  "absolute left-1/2 -translate-x-1/2 z-50 w-72 rounded-xl border border-slate-200 bg-white shadow-xl overflow-hidden",
